            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header text-white bg-success text-center">
                        <h2>Registrar Posicion</h2>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('usuario.posicion.store') }}" method="POST" novalidate>
                            ...
                            <div class="form-group mb-4">
                                <label class="form-label" for="nombre">Nombre de la Posicion</label>
                                <input type="text" name="nombre" id="nombre" class="form-control"
                                    placeholder="Analista | Contador | etc" />
